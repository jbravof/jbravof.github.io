...
function load_window01() {
    ...
    document.body.innerHTML += "<div class='master-window-open' id='window" + (numero_01 + 1) + "'>" +
...
function tool_001(id_03) {
    document.getElementById(id_03).parentElement.innerHTML =
        '<button id="btn01" onclick="tool_001(this.id)">carga</button>';
    var text03 = "";
    ...
    document.getElementById(id_03).parentElement.innerHTML += text03
}