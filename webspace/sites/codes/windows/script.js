...
function adjustFullScreenSize() {
	$(".fullSizeWindow .wincontent").css("width", (window.innerWidth - 40));
...
function load99(){
//alert(document.getElementById('ifr001').contentWindow.document.getElementsByTagName("PRE")[0].innerHTML);
	document.getElementById('div004').innerHTML=document.getElementById('ifr001').contentWindow.document.getElementsByTagName("PRE")[0].innerHTML;
}